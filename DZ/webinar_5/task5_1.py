...
def letter_stat(our_str):
    """
    Принимает на вход строку и возвращает словарь
    с ключем - буква строки, значение - число, количество вхождений данной буквы в строку
    :param our_str: Данная строка
    :return: Получившийся словарь
    """
    # Здесь нужно написать код
    our_str = list(our_str)
    letters_dict = {}
    for element in our_str:
        letters_dict[element] = our_str.count(element)
    return letters_dict
