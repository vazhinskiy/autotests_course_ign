...
def scrabble(word):
    """
    Принимает на вход слово, присваивает за каждую букву определенные очки
    Возвращает колличество очков
    :param word: Слово
    :return: Полученные очки
    """
    # Здесь нужно написать код
    points = 0
    total_points = {1: 'авеёинорст', 2: 'дклмпу', 3: 'бгья', 4: 'йы', 5: 'жзхцч', 8: 'фшэю', 10: 'щ', 15: 'ъ'}
    for a in word:
